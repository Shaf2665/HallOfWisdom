 ...
 * filesystem's own symlink resolution and re-checks containment against
 ...
 * against the underlying filesystem object being replaced afterward. If
 * the canonical form cannot be resolved (e.g. the file no longer exists
 * at this exact moment), this falls back to the already-computed lexical
 * result rather than treating every such case as an escape.
 *
