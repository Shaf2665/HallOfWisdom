 ...
 * what lets `ClaudeCodeRun` present the same `AsyncIterable<NormalizedAgentEvent>`
 * shape `MockAgentRun` does over a real, push-based child process instead
 * of a synchronous generator loop.
 */
