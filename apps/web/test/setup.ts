...
// jsdom does not implement matchMedia. Every consumer here only reads
// `.matches` and (de)registers a "change" listener, so a minimal fake
// covering exactly that surface is enough — never a real media query
// evaluation.
